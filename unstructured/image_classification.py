...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="./cache",
        help="Path to a directory in which to cache datasets and models.",
    )
...
def main():
    ...
    if args.dataset_name is not None:
        ...
        dataset = load_dataset(args.dataset_name, trust_remote_code=args.trust_remote_code, cache_dir=args.cache_dir)
    else:
        data_files = {}
